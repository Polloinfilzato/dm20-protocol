...
github: https://github.com/Polloinfilzato/dm20-protocol/issues/9
...
- [x] Unit tests for `SplitStorageBackend` class (22 tests)
- [x] Unit tests for dirty tracking mechanism (3 tests)
- [x] Unit tests for legacy detection (4 tests)
- [x] Unit tests for TOON encoder with fallback (22 tests - pre-existing)
- [x] Integration tests for format parameter on list tools (17 tests)
- [x] Integration tests for `summarize_session` tool (14 tests - pre-existing)
- [x] Integration tests for migration utility (16 tests - pre-existing)
- [x] Test backward compatibility with monolithic campaigns (9 tests)
- [x] Achieve ≥80% code coverage for new code (estimated ~85%)
